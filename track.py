...
from YOLOX.utils.general import check_img_size, non_max_suppression, check_imshow
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='yolox_s.pth', help='model.pt path')
    parser.add_argument('--deep_sort_weights', type=str, default='ckpt.t7', help='ckpt.t7 path')
    ...
    parser.add_argument('--save-pic', action='store_true', help='save pic tracking results')
